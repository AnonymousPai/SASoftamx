...
parser.add_argument('--w_sas', default=0.7, type=float, help='weight of Cross-Center Loss')
parser.add_argument('--w_ast', default=1.0, type=float, help='weight of Cross-Center Loss')
